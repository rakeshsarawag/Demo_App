						...
						success: function(aEntitySet) {
							...
							return this.waitFor({
								...
								check: function(oList) {
									...
									var sObjectID = oList.getBindingContext().getProperty("WorkItm");

									var iLength = aEntitySet.filter(function(oLineItem) {
										return oLineItem.WorkItm === sObjectID;
									}).length;
				...
				theShareTileButtonShouldContainTheRememberedObjectName: function() {
					return this.waitFor({
						...
						matchers: function(oButton) {
							var sObjectName = this.getContext().currentListItem.getBindingContext().getProperty("DemandItm");
