		...
		onTheMasterPage: {
								...
								success: function(oList) {
									var aItemsNotInTheList = aEntityData.filter(function(oObject) {
										return !oList.getItems().some(function(oListItem) {
											return oListItem.getBindingContext().getProperty("WorkItm") === oObject.WorkItm;
										});
									});
									...
									this.getContext().currentId = aItemsNotInTheList[0].WorkItm;
								},
			...
			assertions: {
				...
				theListHeaderDisplaysZeroHits: function() {
					return this.waitFor({
						...
						matchers: new PropertyStrictEquals({
							name: "title",
							value: "TaskDemandColl (0)"
						}),
						success: function() {
							QUnit.ok(true, "The list header displays 'TaskDemandColl (0)'");
						},
				...
				theListShouldBeSortedAscendingOnName: function() {
					return this.theListShouldBeSortedAscendingOnField("DemandItm");
				},
					...
					return this.waitFor({
						...
						success: function(oList) {
							...
							this.waitFor({
								...
								matchers: new PropertyStrictEquals({
									name: "title",
									value: "TaskDemandColl (" + iExpectedLength + ")"
								}),
								success: function() {
