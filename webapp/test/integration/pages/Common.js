sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("sap.cdp.demo.demoApplication5/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#ManageTasks-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#ManageTasks-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("sap.cdp.demo.demoApplication5.test.integration.pages.Common", {
		...
		getMockServer: function() {
			return new Promise(function(success) {
				Opa5.getWindow().sap.ui.require(["sap.cdp.demo.demoApplication5/localService/mockserver"], function(mockserver) {
